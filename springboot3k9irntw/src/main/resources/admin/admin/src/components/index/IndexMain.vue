<template>
	<div style="height: 100%;">
		<el-main :style='"vertical" == "vertical" ? (2 == 1 ? {"minHeight":"100%","padding":"0","margin":"0 0 0 210px","position":"relative","display":"block"} : (2 == 2 ? (isCollapse ? {"minHeight":"100%","padding":"0","margin":"0 0 0 64px","position":"relative","display":"block"} : {"minHeight":"100%","padding":"90px 0 0 170px","margin":"0","position":"relative","background":"#f6faff","display":"block"}) : "")) : {"minHeight":"100%","margin":"0","position":"relative"}'>
			<!-- top -->
			<index-header :style='{"boxShadow":"0 1px 9px rgba(0,0,0,.3)","padding":"0 20px 0","alignItems":"center","color":"#fff","display":"flex","justifyContent":"flex-end","top":"0","left":"0px","background":"#0977fd","width":"calc(100% - 0px)","fontSize":"16px","position":"fixed","zIndex":"1001","height":"90px"}'></index-header>
			...
			<!-- breadcrumb -->
			<bread-crumbs :title="title" :style='{"padding":"40px 0px 0","margin":"0px auto 0 40px","borderColor":"#3b6885","borderWidth":"0 0 0px 0","background":"none","width":"calc(100% - 40px)","fontSize":"16px","borderStyle":"solid"}' class="bread-crumbs"></bread-crumbs>
