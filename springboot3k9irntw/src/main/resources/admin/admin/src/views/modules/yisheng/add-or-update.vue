	...
	<div class="addEdit-block">
		...
		>
			<template >
				...
				<el-form-item class="upload" v-if="type!='info' && !ro.zigezheng" label="资格证" prop="zigezheng" >
					<file-upload
						tip="点击上传资格证"
						action="file/upload"
						:limit="3"
						...
						@change="zigezhengUploadChange"
					></file-upload>
				</el-form-item>
				<el-form-item class="upload" v-else-if="ruleForm.zigezheng" label="资格证" prop="zigezheng" >
					<img v-if="ruleForm.zigezheng.substring(0,4)=='http'&&ruleForm.zigezheng.split(',w').length>1" class="upload-img" style="margin-right:20px;" v-bind:key="index" :src="ruleForm.zigezheng" width="100" height="100">
					<img v-else-if="ruleForm.zigezheng.substring(0,4)=='http'" class="upload-img" style="margin-right:20px;" v-bind:key="index" :src="ruleForm.zigezheng.split(',')[0]" width="100" height="100">
					<img v-else class="upload-img" style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.zigezheng.split(',')" :src="$base.url+item" width="100" height="100">
				</el-form-item>
			</template>
...
<script>
	...
	export default {
		...
		methods: {
			...
			init(id,type) {
				...
				if(this.type=='info'||this.type=='else'||this.type=='msg'){
					...
					for (var o in obj){
						...
						if(o=='zigezheng'){
							this.ruleForm.zigezheng = obj[o];
							this.ro.zigezheng = true;
							continue;
						}
					}
				}
			...
			zigezhengUploadChange(fileUrls) {
