				...
				<el-table
					...
					<el-table-column
						...
						<template slot-scope="scope">
							<el-button
								type="text"
								:style='{"border":"1px solid #21c79260","cursor":"pointer","padding":"0 10px","margin":"0 5px 5px 0","color":"#21c792","borderRadius":"0px","background":"#fff","width":"auto","fontSize":"14px","height":"32px"}'
								size="small"
